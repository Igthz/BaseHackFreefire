...
namespace FreeFireMemoryHack
{
    public partial class Form1 : Form
    {
        ...
        private async Task<IntPtr> GlockRajaadakk(string type)
        {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            PSPS.ForeColor = Color.Orange;
            DRIERSSSS_LOAD_AUTO_IN_PROCESSS("EXAMPLE");
        }
